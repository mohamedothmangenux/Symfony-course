 ...
 */
class Version20190612112452 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE comments_id post_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE post_id comments_id INT DEFAULT NULL');
